...
<? $tabControl->End();?>
    ...
    <? if($REQUEST_METHOD == "POST" && $apply != ""): ?>
        <script>
            ...
            function startExport(step, product_update = 0, product_add = 0, price_update = 0, price_add = 0, storage_update = 0, storage_add = 0){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data.step < data.total) startExport(step, +data.product_update, +data.product_add, +data.price_update, +data.price_add, +data.storage_update, +data.storage_add);
                            else log();
